InfDev Version of WWTBAM in C++

Controls:
----------------------------------
First time type in the current year!
Then Press Enter!
------------------
Then read the opening text!
...
If you won't input either 'a', 'b', 'c' or 'd' the program stops cuz it processes
as you made a huge mistake.
----------------------------
